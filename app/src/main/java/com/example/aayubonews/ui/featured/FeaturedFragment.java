...
import com.example.aayubonews.ui.gallery.GalleryViewModel;
...
public class FeaturedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        featuredViewModel =
                new ViewModelProvider(this).get(FeaturedViewModel.class);
        ...
        homeWebView.loadUrl("https://aayubo.com/si/featured");
