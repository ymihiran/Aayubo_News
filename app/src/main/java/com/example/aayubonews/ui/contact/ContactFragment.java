package com.example.aayubonews.ui.contact;
...
import com.example.aayubonews.databinding.FragmentContactBinding;
import com.example.aayubonews.ui.about.AboutViewModel;

public class ContactFragment extends Fragment {
    private ContactViewModel featuredViewModel;
    private FragmentContactBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        featuredViewModel =
                new ViewModelProvider(ContactFragment.this).get(ContactViewModel.class);

        binding = FragmentContactBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final WebView homeWebView = binding.webContact;
        final ProgressBar loadingPB = binding.progContact;
        ...
        homeWebView.loadUrl("https://aayubo.com/si/contact");
